...
0|One-Dark|mskelton.one-dark-theme~One Dark|~/.config/swww/One-Dark/autumn.jpg
0|Synth-Wave|robbowen.synthwave-vscode~SynthWave '84|~/.config/swww/Synth-Wave/beach.jpg
0|Nordic-Blue|arcticicestudio.nord-visual-studio-code~Nord|~/.config/swww/Nordic-Blue/forest.jpg
